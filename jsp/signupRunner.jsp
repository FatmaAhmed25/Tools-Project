    ...
    event.preventDefault();
      ...
      try {
          ...
          if (result  === "Signed up!") {
            ...
            window.location.href = `http://localhost:8080/Tools-Akeel/jsp/customerHomePage.jsp?username=${username}&password=${password}`; // Redirect to homepage.jsp with query parameters
